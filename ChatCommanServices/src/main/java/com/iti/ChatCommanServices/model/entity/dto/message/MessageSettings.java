package com.iti.ChatCommanServices.model.entity.dto.message;
...
public class MessageSettings  implements java.io.Serializable {
    ...
    @JoinColumn(name="user_phone_number", nullable=true)
    public User getUser() {
        return this.user;
    }
    ...
    @Column(name="font_size", nullable=true, precision=12, scale=0)
    ...
    @Column(name="font_style", nullable=true, length=20)
    ...
    @Column(name="text_background", nullable=true, length=20)
